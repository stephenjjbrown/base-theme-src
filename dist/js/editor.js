(function () {
  ...
  class ImmutableBlockSettingsManager {
  ...
  var lodash_2 = lodash.cloneDeep;
  var lodash_3 = lodash.merge;
  var lodash_4 = lodash.times;
  var lodash_5 = lodash.memoize;

  class MutableBlockSettingsManager {
      constructor(defaultSettings, initialSettingsJson, settingsJsonChanged) {
          this.settingsJsonChanged = settingsJsonChanged;
          this.settingsChangedHandlers = [];
          try {
      ...
      removeSettingsChangeHandler(id) {
      ...
      updateSettings(obj) {
          ...
          const newSettings = lodash_3(lodash_2(this._settings), obj);
          if (!lodash_1(this._settings, newSettings)) {
  ...
  class MyPeachesElement extends HyperHTMLElement {
      constructor() {
          super(...arguments);
      ...
      initialize(blockSettingsManager) {
  ...
  class MyPeachesEditorElement extends HyperHTMLElement {
      constructor() {
          super(...arguments);
          this.initialized = false;
          this.oninput = (e) => {
  ...
  const { Component: Component$1, createRef } = wp.element;
  class DidMount extends Component$1 {
      componentDidMount() {
  ...
  class MutableBlockSettingsManagerStore {
      ...
      create(id, defaultSettings, initialSettingsJson, settingsJsonChanged) {
          return this._managers[id] = new MutableBlockSettingsManager(defaultSettings, initialSettingsJson, settingsJsonChanged);
      }
      getOrCreate(id, defaultSettings, initialSettingsJson, settingsJsonChanged) {
          const existing = this.get(id);
          return existing || this.create(id, defaultSettings, initialSettingsJson, settingsJsonChanged);
      }
  }
  const mutableBlockSettingsManagerStore = new MutableBlockSettingsManagerStore();

  const defaultMyPeachesBlockSettings = {
      peaches: 32
  };

  const { InspectorControls, InnerBlocks } = wp.editor;
  const { createRef: createRef$1, Fragment } = wp.element;
  const columnsTemplate = (columns) => lodash_4(columns, () => ['core/column']);
  const getManager = (props) => {
      return mutableBlockSettingsManagerStore.getOrCreate(props.clientId, defaultMyPeachesBlockSettings, props.attributes.blockSettingsJson, json => props.setAttributes({
  ...
  wp.blocks.registerBlockType('base-theme/my-peaches', {
      ...
      edit: function (props) {
          ...
          const mainRef = createRef$1();
          const mainDidMount = () => {
              const main = mainRef.current;
              main.initialize(manager);
          };
          const editorRef = createRef$1();
          ...
          return [
              wp.element.createElement("my-peaches", { ref: mainRef, joob: joobValue }),
              wp.element.createElement(DidMount, { callback: mainDidMount }),
              wp.element.createElement(InnerBlocks, { template: columnsTemplate(3), templateLock: "all", allowedBlocks: ['core/column'] }),
              wp.element.createElement(InspectorControls, null,
                  wp.element.createElement("my-peaches-editor", { ref: editorRef }),
                  wp.element.createElement(DidMount, { callback: editorDidMount }))
          ];
      },
      save: function (props) {
          return wp.element.createElement(Fragment, null,
              wp.element.createElement("my-peaches", { "data-block-settings": props.attributes.blockSettingsJson }),
              ",",
              wp.element.createElement(InnerBlocks.Content, null));
      },
  });

  const { InspectorControls: InspectorControls$1, InnerBlocks: InnerBlocks$1, MediaPlaceholder } = wp.editor;
  ...
  const settings = wp.blocks.registerBlockType('base-theme/image-section', {
      ...
      edit: function (props, state) {
          ...
          return wp.element.createElement(Fragment$1, null,
              wp.element.createElement("div", { className: "bt-image-section" },
                  wp.element.createElement("div", { className: "bt-image-section-column" }, props.attributes.imageUrl ?
                      ...
                      wp.element.createElement(MediaPlaceholder, { icon: "format-image", labels: {
                              title: "Image",
                              name: "an Image",
                          }, className: "place", onSelect: onSelectImage, 
                          // notices={ noticeUI }
                          // onError={ noticeOperations.createErrorNotice }
                          accept: "image/*", type: "image" })),
                  wp.element.createElement("div", { className: "bt-image-section-column" },
                      wp.element.createElement(InnerBlocks$1, { template: [['core/column']], templateLock: "all" }))),
              wp.element.createElement(InspectorControls$1, null,
                  wp.element.createElement("input", { type: "text", value: props.attributes.imageUrl, onBlur: onchange, onKeyUp: onkeyup })));
      },
      save: function (props) {
          return wp.element.createElement(Fragment$1, null,
              wp.element.createElement("div", { className: "bt-image-section" },
                  wp.element.createElement("div", { className: "bt-image-section-column" },
                      wp.element.createElement("img", { src: props.attributes.imageUrl })),
                  wp.element.createElement("div", { className: "bt-image-section-column" },
                      wp.element.createElement(InnerBlocks$1.Content, null))));
      }
  });
