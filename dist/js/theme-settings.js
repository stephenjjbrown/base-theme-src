(function () {
  ...
  var setPrototypeOf$1 = O.setPrototypeOf || function (o, p) {
  ...
  var HyperHTMLElement = function (_HTMLElement) {
    ...
    HyperHTMLElement.define = function define$$1(name, options) {
      ...
      if (options && options.extends) {
        ...
        setPrototypeOf$1(Class, Intermediate);
        setPrototypeOf$1(proto, Intermediate.prototype);
  ...
  var ThemeSettingsElement = function (_HyperHTMLElement) {
    inheritsLoose(ThemeSettingsElement, _HyperHTMLElement);

    function ThemeSettingsElement() {
      var _this;

      _this = _HyperHTMLElement.apply(this, arguments) || this;
      _this.settings = new TrackedSubject(null);
      _this.saveInProgress = new TrackedSubject(false);

      _this.inputChanged = function (event) {
        _this.settings.value = Object.assign(Object.assign({}, _this.settings.value), {
      ...
      _this.saveClicked = function (event) {
        ...
        fetch(wpApiSettings.restUrl + "base-api/v1/public-settings", {
          ...
          _this.saveInProgress.value = false;
        });
      };
    ...
    _proto.created = function created() {
      ...
      this.saveInProgress.subscribe(function () {
        return _this2.render();
      });
    ...
    _proto.render = function render() {
      ...
      return this.html(_templateObject(), this.settings.value === null ? "Loading..." : ThemeSettingsElement.wire(this)(_templateObject2(), this.settings.value.footerPageId || "", this.inputChanged), this.saveClicked, this.saveInProgress.value ? "Saving..." : null);
    };
