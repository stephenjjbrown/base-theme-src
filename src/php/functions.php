...
define('BaseThemeDirectory', '/base-theme');
...
function baseThemeSettingsPageScripts($hook) {
	...
	wp_enqueue_script( "monaco", TemplateDirectoryUri . "/js/monaco-editor/vs/loader.js", [], null, true);
...
function base_theme_blocks() {
	...
	// Deferred to theme to extend and register
	// wp_register_style(
	// 	$handle,
 ...
 */
require TemplateDirectory . '/php/inc/custom-header.php';

/**
 * Custom template tags for this theme.
 */
require TemplateDirectory . '/php/inc/template-tags.php';

/**
 * Functions which enhance the theme by hooking into WordPress.
 */
require TemplateDirectory . '/php/inc/template-functions.php';

/**
 * Customizer additions.
 */
require TemplateDirectory . '/php/inc/customizer.php';

/**
 * Load Jetpack compatibility file.
 */
if ( defined( 'JETPACK__VERSION' ) ) {
	require TemplateDirectory . '/php/inc/jetpack.php';
}

/**
 * Register custom API routes for Base Theme
 */
require TemplateDirectory . '/php/api/register-routes.php';
